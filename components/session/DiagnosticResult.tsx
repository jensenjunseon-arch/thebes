...
const RISK: Record<ConstructId, { weak: string; crisis: string }> = {
  ...
  english: {
    weak: "영어로 직접 문장을 써서 사고를 표현하는 힘 — 영어 작문이 아직 약해요.",
    crisis:
      "예시를 고르는 것과 직접 쓰는 건 전혀 달라요. AI는 속으로 영어로 사고합니다. 생각은 있는데 영어로 ‘직접 써내지’ 못하면, 정작 AI가 생각하는 언어로는 한 박자 늦어요. ‘영어 따로·수학 따로’는 AI 시대 준비가 안 됐다는 신호입니다.",
  },
};
