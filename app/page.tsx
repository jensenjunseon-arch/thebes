          ...
          <Reveal>
            <div className="lp-section-head">
              ...
              <p className="lede">
                ...
                &lsquo;질문하는 AI&rsquo;가 아니라 — 문제가 들어와 결과물이 되기까지,{" "}
                <b>네 단계 전부</b>에 있습니다.
              </p>
            </div>
          </Reveal>
          <Reveal delay={140}>
            <div className="lp-vs-table">
              ...
              {[
                {
                  dim: "문제 입력",
                  them: "문제를 직접 타이핑 — 한국어 그대로 풉니다",
                  us: "교과서 사진 한 장 → 영어로 변환, 단어 뜻·도형 회전까지",
                },
                {
                  dim: "푸는 과정",
                  them: "정답을 향한 한 덩어리 대화",
                  us: "영어로 한 줄씩 — 줄마다 1초 코칭, 막히면 따라쓰기",
                },
                {
                  dim: "결과물",
                  them: "대화가 끝나면 아무것도 남지 않음",
                  us: "내 풀이가 게임·퀴즈로 — 그 자리서 실행하고 링크로 공유",
                },
                {
                  dim: "성장 측정",
                  them: "사고력이 늘었는지 보여주지 못함",
